        ...
        <div className="flex-1 relative">
          <div className="absolute inset-4 rounded-2xl overflow-hidden border-2 border-purple-500/30 shadow-2xl">
            ...
            <div className="absolute top-4 left-4 bg-black/70 backdrop-blur-sm rounded-lg p-3 text-white">
              ...
              <p className="text-xs text-purple-300">👆 Usar o polegar e indicador para desenhar</p>
      ...
      <footer className="bg-black/30 backdrop-blur-md border-t border-purple-500/20 p-4">
        <div className="text-center">
          <p className="text-purple-300 text-sm">
           Desenvolvido com ❤️ por Ana Beatriz e Livia fernandes <br />
           Inspiração: <a href="https://www.linkedin.com/in/vict%C3%B3ria-freyre-220b05291/" className="text-purple-400 font-semibold" target="_blank" rel="noopener noreferrer">Victória Freyre</a>
          </p>
